    ...
    type
      ...
      UserSessionObj* = ref object
        ...
        userId: Option[string]
          # The user id associated with the session. This is used to identify the user
          # associated with the session without having to query the database for the session payload.
